...
import io.emarketeer.json.gson.GsonAdapter;
...
@LibraryPathSets("gson-deps/gson-2.8.2.jar")
public class GsonFactoryTest {
    ...
    public void testToJson() {
        ...
        assertThat(JsonAdapterFactory.__resolved.get()).isInstanceOf(GsonAdapter.class);
    }
